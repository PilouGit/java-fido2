 ...
 * @since 0.8.0
 */
public class AuthenticationCommandExample2 extends BaseExample {
  ...
  public static void main(String[] args) throws HidException {
    ...
    AuthenticationCommandExample2 example = new AuthenticationCommandExample2();
  ...
  public void hidDataReceived(HidServicesEvent event) {
   ...
   // System.err.println(responseCmd);
  }
}